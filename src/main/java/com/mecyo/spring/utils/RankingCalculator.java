        ...
        try {
            ...
            for (TextDetection text: textCollection) {
            	...
            	if(position < 9) {
	            	...
	            	if(guerra && btnX && Strings.isNotEmpty(name) && points.equals(ZERO) && text.detectedText().equals(ZERO.toString())) {
	            	...
	            	if(Strings.isNotEmpty(name) && points > TREZENTOS) {
	            		//TODO forçar cadastro no site para poder ser premiado if(repository.findByNickname(name) != null) {
